...
List<Widget> termsChildren() => const [
      ...
      Para(
        '6. No guarantee of data — use at your own risk',
      ...
      Center(
        child: Column(
          children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    right: 8,
                    top: 6,
                    child: Floating(phase: 0.4, child: SpinningCoin(size: 34)),
                  ),
                ],
              ),
            ),
            ...
            const BrandSlogan(onDark: false, compact: true),
            const SizedBox(height: 8),
